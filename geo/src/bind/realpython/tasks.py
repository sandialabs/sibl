# Reference:
# https://github.com/realpython/materials/blob/master/python-bindings/tasks.py
...
def build_cppmult(c):
    ...
    print("* Complete (Chad says hi!)")


"""
Run on command line to see the magic:
> conda activate siblenv
> python -m pybind11 --includes
-I/Users/sparta/opt/miniconda3/envs/siblenv/include/python3.9 -I/Users/sparta/opt/miniconda3/envs/siblenv/lib/python3.9/site-packages/pybind11/include
>
>
> python3.9-config --extension-suffix               (siblenv)  Mon Oct 25 17:45:15 2021
...
def compile_python_module(cpp_name, extension_name):
    invoke.run(
        "g++ -O3 -Wall -Werror -shared -std=c++11 -undefined dynamic_lookup "
        "`python -m pybind11 --includes` "
        "-I .  "
        "{0} "
...
def test_pybind11(c):
    ...
    invoke.run("python pybind11_test.py", pty=True)
