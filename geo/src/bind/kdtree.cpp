...
KDTree::KDTree(std::vector<IntersectionPrimitives::PolygonSegment> segs) : 
...
KDTreeNode::KDTreeNode(std::vector<IntersectionPrimitives::PolygonSegment const*> const& segs) :
	m_bbox(segs)
{
