...
class OctTree
{
    public:
        ...
        OctTreeNode* head(){return myHead;}
  ...
  int maxLevel(OctTreeNode_ptr qt);
    ...
    private:
        ...
        std::string ip1(std::string c){return direction(c,0,true);}
        std::string im1(std::string c){return direction(c,0,false);}
        std::string jp1(std::string c){return direction(c,1,true);}
        std::string jm1(std::string c){return direction(c,1,false);}
        std::string kp1(std::string c){return direction(c,2,true);}
        std::string km1(std::string c){return direction(c,2,false);}
