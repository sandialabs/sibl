...
void OctTree::testAndSubdivide(OctTreeNode_ptr qt,  int cardinal)
{
   ...
   switch(cardinal)
   {
       case 1: test= ip1(qt->locationcode);break;
       case 2: test= im1(qt->locationcode);break;
       case 3: test= jp1(qt->locationcode);break;
       case 4: test= jm1(qt->locationcode);break;
       case 5: test= kp1(qt->locationcode);break;
       case 6: test= km1(qt->locationcode);break;
       default: test= ip1(qt->locationcode);break;
   }
