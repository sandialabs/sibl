"""This module smooths the non-smoothed dual mesh output from the
SIBL mesh engine.
"""
...
input_mesh_file = script_path.joinpath("lesson_21_mesh.inp")
...
while k <= n_iterations and not converged:
    ...
    if not (k % plot_interval):
        ...
        if fig_dict["serialize"]:
            filename = script_name + "_hist_" + iter_str_3_digit + ".png"
